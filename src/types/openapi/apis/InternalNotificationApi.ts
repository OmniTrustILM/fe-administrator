...
import type { AuthenticationServiceExceptionDto, ErrorMessageDto, NotificationResponseDto } from '../models';
...
export class InternalNotificationApi extends BaseAPI {
    ...
    bulkMarkNotificationAsRead(
        { requestBody }: BulkMarkNotificationAsReadRequest,
        opts?: OperationOpts,
    ...
    listNotifications(
        ...
        opts?: OperationOpts,
    ): Observable<AjaxResponse<NotificationResponseDto>>;
    listNotifications(
        { unread, itemsPerPage, pageNumber }: ListNotificationsRequest,
        opts?: OperationOpts,
