...
export class AuthorityManagementApi extends BaseAPI {
     ...
     */
    validateRAProfileAttributes({ uuid, requestAttribute }: ValidateRAProfileAttributesRequest): Observable<void>;
    validateRAProfileAttributes(
        { uuid, requestAttribute }: ValidateRAProfileAttributesRequest,
        opts?: OperationOpts,
    ...
    validateRAProfileAttributes(
        ...
        throwIfNullOrUndefined(requestAttribute, 'requestAttribute', 'validateRAProfileAttributes');
