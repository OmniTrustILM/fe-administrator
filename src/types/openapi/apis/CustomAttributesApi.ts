...
export interface UpdateAttributeContentForResourceRequest {
    ...
    objectUuid: string;
    attributeUuid: string;
    attributeContent: Array<AttributeContent>;
}
...
export class CustomAttributesApi extends BaseAPI {
    ...
    deleteAttributeContentForResource({
        ...
        objectUuid,
        attributeUuid,
    }: DeleteAttributeContentForResourceRequest): Observable<Array<ResponseAttribute>>;
    deleteAttributeContentForResource(
        { resourceName, objectUuid, attributeUuid }: DeleteAttributeContentForResourceRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<Array<ResponseAttribute>>>;
    deleteAttributeContentForResource(
        { resourceName, objectUuid, attributeUuid }: DeleteAttributeContentForResourceRequest,
        opts?: OperationOpts,
    ): Observable<Array<ResponseAttribute> | AjaxResponse<Array<ResponseAttribute>>> {
        ...
        return this.request<Array<ResponseAttribute>>(
            {
    ...
    editCustomAttribute({
        uuid,
        customAttributeUpdateRequestDto,
    }: EditCustomAttributeRequest): Observable<CustomAttributeDefinitionDetailDto>;
    editCustomAttribute(
        { uuid, customAttributeUpdateRequestDto }: EditCustomAttributeRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<CustomAttributeDefinitionDetailDto>>;
    editCustomAttribute(
        { uuid, customAttributeUpdateRequestDto }: EditCustomAttributeRequest,
        opts?: OperationOpts,
    ...
    getResourceCustomAttributes(
        { resource }: GetResourceCustomAttributesRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<Array<CustomAttribute>>>;
    getResourceCustomAttributes(
        { resource }: GetResourceCustomAttributesRequest,
        opts?: OperationOpts,
    ...
    updateAttributeContentForResource({
        ...
        attributeUuid,
        attributeContent,
    }: UpdateAttributeContentForResourceRequest): Observable<Array<ResponseAttribute>>;
    updateAttributeContentForResource(
        { resourceName, objectUuid, attributeUuid, attributeContent }: UpdateAttributeContentForResourceRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<Array<ResponseAttribute>>>;
    updateAttributeContentForResource(
        { resourceName, objectUuid, attributeUuid, attributeContent }: UpdateAttributeContentForResourceRequest,
        ...
        throwIfNullOrUndefined(attributeContent, 'attributeContent', 'updateAttributeContentForResource');
