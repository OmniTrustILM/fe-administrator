...
export interface UpdateBrandingSettingsRequest {
    brandingSettingsUpdateDto: BrandingSettingsUpdateDto;
}
...
export class SettingsApi extends BaseAPI {
    ...
    /**
     * Reads the branding category of the platform settings. Branding is also returned by `GET /v1/settings/platform`; only the write is split onto a dedicated endpoint, because reading it takes the same grant either way.
     * Get platform branding
     */
    getBrandingSettings(): Observable<BrandingSettingsDto>;
    getBrandingSettings(opts?: OperationOpts): Observable<AjaxResponse<BrandingSettingsDto>>;
    getBrandingSettings(opts?: OperationOpts): Observable<BrandingSettingsDto | AjaxResponse<BrandingSettingsDto>> {
        return this.request<BrandingSettingsDto>(
            {
                url: '/v1/settings/platform/branding',
                method: 'GET',
            },
            opts?.responseOpts,
        );
    ...
    updateBrandingSettings(
        { brandingSettingsUpdateDto }: UpdateBrandingSettingsRequest,
        opts?: OperationOpts,
    ): Observable<void | AjaxResponse<void>>;
    updateBrandingSettings(
        { brandingSettingsUpdateDto }: UpdateBrandingSettingsRequest,
        ...
        throwIfNullOrUndefined(brandingSettingsUpdateDto, 'brandingSettingsUpdateDto', 'updateBrandingSettings');
        ...
        return this.request<void>(
            {
                ...
                method: 'PUT',
                headers,
                body: brandingSettingsUpdateDto,
            },
            opts?.responseOpts,
        );
    }
