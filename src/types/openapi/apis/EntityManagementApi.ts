...
export class EntityManagementApi extends BaseAPI {
     ...
     */
    validateLocationAttributes({ entityUuid, requestAttribute }: ValidateLocationAttributesRequest): Observable<void>;
    validateLocationAttributes(
        { entityUuid, requestAttribute }: ValidateLocationAttributesRequest,
        opts?: OperationOpts,
    ...
    validateLocationAttributes(
        ...
        throwIfNullOrUndefined(requestAttribute, 'requestAttribute', 'validateLocationAttributes');
