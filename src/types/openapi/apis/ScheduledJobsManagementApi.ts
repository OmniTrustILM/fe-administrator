...
export class ScheduledJobsManagementApi extends BaseAPI {
    ...
    getScheduledJobHistory(
        { uuid, itemsPerPage, pageNumber }: GetScheduledJobHistoryRequest,
        opts?: OperationOpts,
    ...
    listScheduledJobs(
        ...
        opts?: OperationOpts,
    ): Observable<AjaxResponse<ScheduledJobsResponseDto>>;
    listScheduledJobs(
        { itemsPerPage, pageNumber }: ListScheduledJobsRequest,
        opts?: OperationOpts,
    ...
    updateScheduledJob(
        { uuid, updateScheduledJob }: UpdateScheduledJobRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<ScheduledJobDetailDto>>;
    updateScheduledJob(
        { uuid, updateScheduledJob }: UpdateScheduledJobRequest,
        opts?: OperationOpts,
    ): Observable<ScheduledJobDetailDto | AjaxResponse<ScheduledJobDetailDto>> {
