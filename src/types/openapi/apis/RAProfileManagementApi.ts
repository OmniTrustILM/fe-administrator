...
export interface ListRaProfileIdentifyCertificateAttributesRequest {
    authorityUuid: string;
    raProfileUuid: string;
}
...
export interface ListRaProfileRenewCertificateAttributesRequest {
    authorityUuid: string;
    raProfileUuid: string;
}
...
export class RAProfileManagementApi extends BaseAPI {
    ...
    activateAcmeForRaProfile({
        ...
        acmeProfileUuid,
        activateAcmeForRaProfileRequestDto,
    }: ActivateAcmeForRaProfileRequest): Observable<RaProfileAcmeDetailResponseDto>;
    activateAcmeForRaProfile(
        { authorityUuid, raProfileUuid, acmeProfileUuid, activateAcmeForRaProfileRequestDto }: ActivateAcmeForRaProfileRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<RaProfileAcmeDetailResponseDto>>;
    activateAcmeForRaProfile(
        { authorityUuid, raProfileUuid, acmeProfileUuid, activateAcmeForRaProfileRequestDto }: ActivateAcmeForRaProfileRequest,
        opts?: OperationOpts,
    ...
    activateCmpForRaProfile({
        ...
        cmpProfileUuid,
        activateCmpForRaProfileRequestDto,
    }: ActivateCmpForRaProfileRequest): Observable<RaProfileCmpDetailResponseDto>;
    activateCmpForRaProfile(
        { authorityUuid, raProfileUuid, cmpProfileUuid, activateCmpForRaProfileRequestDto }: ActivateCmpForRaProfileRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<RaProfileCmpDetailResponseDto>>;
    activateCmpForRaProfile(
        { authorityUuid, raProfileUuid, cmpProfileUuid, activateCmpForRaProfileRequestDto }: ActivateCmpForRaProfileRequest,
        opts?: OperationOpts,
    ): Observable<RaProfileCmpDetailResponseDto | AjaxResponse<RaProfileCmpDetailResponseDto>> {
        ...
        return this.request<RaProfileCmpDetailResponseDto>(
            {
                url: '/v1/authorities/{authorityUuid}/raProfiles/{raProfileUuid}/protocols/cmp/activate/{cmpProfileUuid}'
                    .replace('{authorityUuid}', encodeURI(authorityUuid))
                    .replace('{raProfileUuid}', encodeURI(raProfileUuid))
    ...
    activateScepForRaProfile({
        ...
        scepProfileUuid,
        activateScepForRaProfileRequestDto,
    }: ActivateScepForRaProfileRequest): Observable<RaProfileScepDetailResponseDto>;
    activateScepForRaProfile(
        { authorityUuid, raProfileUuid, scepProfileUuid, activateScepForRaProfileRequestDto }: ActivateScepForRaProfileRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<RaProfileScepDetailResponseDto>>;
    activateScepForRaProfile(
        { authorityUuid, raProfileUuid, scepProfileUuid, activateScepForRaProfileRequestDto }: ActivateScepForRaProfileRequest,
        opts?: OperationOpts,
    ...
    deactivateCmpForRaProfile(
        { authorityUuid, raProfileUuid }: DeactivateCmpForRaProfileRequest,
        opts?: OperationOpts,
    ): Observable<void | AjaxResponse<void>>;
    deactivateCmpForRaProfile(
        { authorityUuid, raProfileUuid }: DeactivateCmpForRaProfileRequest,
        ...
        return this.request<void>(
            {
                url: '/v1/authorities/{authorityUuid}/raProfiles/{raProfileUuid}/protocols/cmp/deactivate'
                    .replace('{authorityUuid}', encodeURI(authorityUuid))
                    .replace('{raProfileUuid}', encodeURI(raProfileUuid)),
                method: 'PATCH',
            },
    ...
    /**
     * Delete RA Profile without Authority
     */
    ...
    getAssociatedComplianceProfiles({
        authorityUuid,
        raProfileUuid,
    }: GetAssociatedComplianceProfilesRequest): Observable<Array<SimplifiedComplianceProfileDto>>;
    getAssociatedComplianceProfiles(
        { authorityUuid, raProfileUuid }: GetAssociatedComplianceProfilesRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<Array<SimplifiedComplianceProfileDto>>>;
    getAssociatedComplianceProfiles(
        { authorityUuid, raProfileUuid }: GetAssociatedComplianceProfilesRequest,
        opts?: OperationOpts,
    ...
    getCmpForRaProfile(
        { authorityUuid, raProfileUuid }: GetCmpForRaProfileRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<RaProfileCmpDetailResponseDto>>;
    getCmpForRaProfile(
        { authorityUuid, raProfileUuid }: GetCmpForRaProfileRequest,
        ...
        return this.request<RaProfileCmpDetailResponseDto>(
            {
                url: '/v1/authorities/{authorityUuid}/raProfiles/{raProfileUuid}/protocols/cmp'
                    .replace('{authorityUuid}', encodeURI(authorityUuid))
                    .replace('{raProfileUuid}', encodeURI(raProfileUuid)),
                method: 'GET',
            },
    ...
    /**
     * Details of RA Profile without Authority
     */
     ...
     */
    listRaProfileIdentifyCertificateAttributes({
        authorityUuid,
        raProfileUuid,
    }: ListRaProfileIdentifyCertificateAttributesRequest): Observable<Array<BaseAttributeDto>>;
    listRaProfileIdentifyCertificateAttributes(
        { authorityUuid, raProfileUuid }: ListRaProfileIdentifyCertificateAttributesRequest,
        opts?: OperationOpts,
    ...
    listRaProfileIdentifyCertificateAttributes(
        ...
        throwIfNullOrUndefined(authorityUuid, 'authorityUuid', 'listRaProfileIdentifyCertificateAttributes');
        throwIfNullOrUndefined(raProfileUuid, 'raProfileUuid', 'listRaProfileIdentifyCertificateAttributes');

        return this.request<Array<BaseAttributeDto>>(
            {
                url: '/v1/authorities/{authorityUuid}/raProfiles/{raProfileUuid}/attributes/identify'
                    .replace('{authorityUuid}', encodeURI(authorityUuid))
                    .replace('{raProfileUuid}', encodeURI(raProfileUuid)),
                method: 'GET',
            },
    ...
    listRaProfileIssueCertificateAttributes({
        authorityUuid,
        raProfileUuid,
    }: ListRaProfileIssueCertificateAttributesRequest): Observable<Array<BaseAttributeDto>>;
    listRaProfileIssueCertificateAttributes(
     ...
     */
    listRaProfileRenewCertificateAttributes({
        authorityUuid,
        raProfileUuid,
    }: ListRaProfileRenewCertificateAttributesRequest): Observable<Array<BaseAttributeDto>>;
    listRaProfileRenewCertificateAttributes(
        { authorityUuid, raProfileUuid }: ListRaProfileRenewCertificateAttributesRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<Array<BaseAttributeDto>>>;
    listRaProfileRenewCertificateAttributes(
        { authorityUuid, raProfileUuid }: ListRaProfileRenewCertificateAttributesRequest,
        ...
        throwIfNullOrUndefined(authorityUuid, 'authorityUuid', 'listRaProfileRenewCertificateAttributes');
        throwIfNullOrUndefined(raProfileUuid, 'raProfileUuid', 'listRaProfileRenewCertificateAttributes');

        return this.request<Array<BaseAttributeDto>>(
            {
                url: '/v1/authorities/{authorityUuid}/raProfiles/{raProfileUuid}/attributes/renew'
                    .replace('{authorityUuid}', encodeURI(authorityUuid))
                    .replace('{raProfileUuid}', encodeURI(raProfileUuid)),
                method: 'GET',
            },
    ...
    listRaProfileRevokeCertificateAttributes({
        authorityUuid,
        raProfileUuid,
    }: ListRaProfileRevokeCertificateAttributesRequest): Observable<Array<BaseAttributeDto>>;
    listRaProfileRevokeCertificateAttributes(
    ...
    updateRaProfileValidationConfiguration({
        ...
        raProfileUuid,
        raProfileCertificateValidationSettingsUpdateDto,
    }: UpdateRaProfileValidationConfigurationRequest): Observable<RaProfileDto>;
    updateRaProfileValidationConfiguration(
        { authorityUuid, raProfileUuid, raProfileCertificateValidationSettingsUpdateDto }: UpdateRaProfileValidationConfigurationRequest,
        opts?: OperationOpts,
    ): Observable<AjaxResponse<RaProfileDto>>;
    updateRaProfileValidationConfiguration(
        { authorityUuid, raProfileUuid, raProfileCertificateValidationSettingsUpdateDto }: UpdateRaProfileValidationConfigurationRequest,
        ...
        return this.request<RaProfileDto>(
            {
                url: '/v1/authorities/{authorityUuid}/raProfiles/{raProfileUuid}/validation'
                    .replace('{authorityUuid}', encodeURI(authorityUuid))
                    .replace('{raProfileUuid}', encodeURI(raProfileUuid)),
                method: 'PATCH',
                headers,
