 ...
 * no description
 */
export class TokenInstanceManagementApi extends BaseAPI {
    /**
     * Activate Token Instance
     */
    activateTokenInstance({ uuid, requestAttribute }: ActivateTokenInstanceRequest): Observable<void>;
    activateTokenInstance(
        { uuid, requestAttribute }: ActivateTokenInstanceRequest,
        opts?: OperationOpts,
    ...
    activateTokenInstance(
        ...
        throwIfNullOrUndefined(requestAttribute, 'requestAttribute', 'activateTokenInstance');
    ...
    /**
     * Delete multiple Token Instances
     */
