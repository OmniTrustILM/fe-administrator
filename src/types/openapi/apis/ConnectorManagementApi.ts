...
export class ConnectorManagementApi extends BaseAPI {
     ...
     * Validate Attributes
     */
    validateAttributes({ uuid, functionGroup, kind, requestAttribute }: ValidateAttributesRequest): Observable<void>;
    validateAttributes(
        { uuid, functionGroup, kind, requestAttribute }: ValidateAttributesRequest,
        opts?: OperationOpts,
    ...
    validateAttributes(
        ...
        throwIfNullOrUndefined(requestAttribute, 'requestAttribute', 'validateAttributes');
