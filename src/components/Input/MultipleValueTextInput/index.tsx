    ...
    return (
        <div className="flex gap-2">
            ...
            <div className="flex gap-2">
                <input
                    type="text"
                    className="text-content py-2.5 sm:py-3 px-4 block border-outline rounded-lg text-sm focus:border-brand focus:ring-brand bg-surface-raised placeholder-content-hint"
                    value={newValue}
