 ...
 * a box asks the operator to change a field, so it has to name that field by the colour the form calls it. The scope
 * qualifier stays on the form field, since repeating it in every box would say nothing about the contrast.
 */
